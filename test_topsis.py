#we will ask the user to provide us the name of the alternative and the criteria
#Example 1
import pandas as pd
import numpy as np
...
t=topsis(criteria_names, alternative_names, data, weights_criteria, benificial_cost_mark, dict_encode) 
