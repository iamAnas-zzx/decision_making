...
matrix_per_criteria=np.array([criteria1, criteria2, criteria3, criteria4], dtype=str) #list of matrix containing alternative to alternative comparision for every single criteria
